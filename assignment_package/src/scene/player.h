...
private:
    ...
    int inWater; //0 = no, 1 = body, 2 = camera
    int inLava;
...
public:
    ...
    void breakBlock(Terrain& terrain) const;
    void placeBlock(Terrain& terrain, BlockType block) const;
    ...
    bool getCamInWater() const;
    bool getCamInLava() const;
    bool getBodyInWater() const;
    bool getBodyInLava() const;
};
